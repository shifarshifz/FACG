public enum FaIcon {
	...
	FA_AMAZON(R.string.fa_amazon),
	FA_AMBULANCE(R.string.fa_ambulance),
	FA_AMERICAN_SIGN_LANGUAGE_INTERPRETING(R.string.fa_american_sign_language_interpreting),
	...
	FA_ASL_INTERPRETING(R.string.fa_asl_interpreting),
	FA_ASSISTIVE_LISTENING_SYSTEMS(R.string.fa_assistive_listening_systems),
	FA_ASTERISK(R.string.fa_asterisk),
	FA_AT(R.string.fa_at),
	FA_AUDIO_DESCRIPTION(R.string.fa_audio_description),
	FA_AUTOMOBILE(R.string.fa_automobile),
	FA_BACKWARD(R.string.fa_backward),
	FA_BALANCE_SCALE(R.string.fa_balance_scale),
	...
	FA_BATTERY_0(R.string.fa_battery_0),
	FA_BATTERY_1(R.string.fa_battery_1),
	FA_BATTERY_2(R.string.fa_battery_2),
	FA_BATTERY_3(R.string.fa_battery_3),
	FA_BATTERY_4(R.string.fa_battery_4),
	FA_BATTERY_EMPTY(R.string.fa_battery_empty),
	FA_BATTERY_FULL(R.string.fa_battery_full),
	FA_BATTERY_HALF(R.string.fa_battery_half),
	FA_BATTERY_QUARTER(R.string.fa_battery_quarter),
	FA_BATTERY_THREE_QUARTERS(R.string.fa_battery_three_quarters),
	...
	FA_BLACK_TIE(R.string.fa_black_tie),
	FA_BLIND(R.string.fa_blind),
	FA_BLUETOOTH(R.string.fa_bluetooth),
	FA_BLUETOOTH_B(R.string.fa_bluetooth_b),
	...
	FA_BRAILLE(R.string.fa_braille),
	...
	FA_CALENDAR_CHECK_O(R.string.fa_calendar_check_o),
	FA_CALENDAR_MINUS_O(R.string.fa_calendar_minus_o),
	FA_CALENDAR_O(R.string.fa_calendar_o),
	FA_CALENDAR_PLUS_O(R.string.fa_calendar_plus_o),
	FA_CALENDAR_TIMES_O(R.string.fa_calendar_times_o),
	...
	FA_CC_DINERS_CLUB(R.string.fa_cc_diners_club),
	FA_CC_DISCOVER(R.string.fa_cc_discover),
	FA_CC_JCB(R.string.fa_cc_jcb),
	...
	FA_CODIEPIE(R.string.fa_codiepie),
	...
	FA_COMMENTING(R.string.fa_commenting),
	FA_COMMENTING_O(R.string.fa_commenting_o),
	...
	FA_CONTAO(R.string.fa_contao),
	FA_COPY(R.string.fa_copy),
	FA_COPYRIGHT(R.string.fa_copyright),
	FA_CREATIVE_COMMONS(R.string.fa_creative_commons),
	FA_CREDIT_CARD(R.string.fa_credit_card),
	FA_CREDIT_CARD_ALT(R.string.fa_credit_card_alt),
	...
	FA_DEAF(R.string.fa_deaf),
	FA_DEAFNESS(R.string.fa_deafness),
	...
	FA_EXPEDITEDSSL(R.string.fa_expeditedssl),
	...
	FA_FIREFOX(R.string.fa_firefox),
	FA_FIRST_ORDER(R.string.fa_first_order),
	...
	FA_FONT_AWESOME(R.string.fa_font_awesome),
	FA_FONTICONS(R.string.fa_fonticons),
	FA_FORT_AWESOME(R.string.fa_fort_awesome),
	...
	FA_GET_POCKET(R.string.fa_get_pocket),
	FA_GG(R.string.fa_gg),
	FA_GG_CIRCLE(R.string.fa_gg_circle),
	...
	FA_GITLAB(R.string.fa_gitlab),
	FA_GITTIP(R.string.fa_gittip),
	FA_GLASS(R.string.fa_glass),
	FA_GLIDE(R.string.fa_glide),
	FA_GLIDE_G(R.string.fa_glide_g),
	FA_GLOBE(R.string.fa_globe),
	FA_GOOGLE(R.string.fa_google),
	FA_GOOGLE_PLUS(R.string.fa_google_plus),
	FA_GOOGLE_PLUS_CIRCLE(R.string.fa_google_plus_circle),
	FA_GOOGLE_PLUS_OFFICIAL(R.string.fa_google_plus_official),
	...
	FA_HAND_GRAB_O(R.string.fa_hand_grab_o),
	FA_HAND_LIZARD_O(R.string.fa_hand_lizard_o),
	...
	FA_HAND_PAPER_O(R.string.fa_hand_paper_o),
	FA_HAND_PEACE_O(R.string.fa_hand_peace_o),
	FA_HAND_POINTER_O(R.string.fa_hand_pointer_o),
	FA_HAND_ROCK_O(R.string.fa_hand_rock_o),
	FA_HAND_SCISSORS_O(R.string.fa_hand_scissors_o),
	FA_HAND_SPOCK_O(R.string.fa_hand_spock_o),
	FA_HAND_STOP_O(R.string.fa_hand_stop_o),
	FA_HARD_OF_HEARING(R.string.fa_hard_of_hearing),
	FA_HASHTAG(R.string.fa_hashtag),
	...
	FA_HOURGLASS(R.string.fa_hourglass),
	FA_HOURGLASS_1(R.string.fa_hourglass_1),
	FA_HOURGLASS_2(R.string.fa_hourglass_2),
	FA_HOURGLASS_3(R.string.fa_hourglass_3),
	FA_HOURGLASS_END(R.string.fa_hourglass_end),
	FA_HOURGLASS_HALF(R.string.fa_hourglass_half),
	FA_HOURGLASS_O(R.string.fa_hourglass_o),
	FA_HOURGLASS_START(R.string.fa_hourglass_start),
	FA_HOUZZ(R.string.fa_houzz),
	FA_HTML5(R.string.fa_html5),
	FA_I_CURSOR(R.string.fa_i_cursor),
	FA_ILS(R.string.fa_ils),
	FA_IMAGE(R.string.fa_image),
	FA_INBOX(R.string.fa_inbox),
	FA_INDENT(R.string.fa_indent),
	FA_INDUSTRY(R.string.fa_industry),
	...
	FA_INTERNET_EXPLORER(R.string.fa_internet_explorer),
	FA_INTERSEX(R.string.fa_intersex),
	...
	FA_LOW_VISION(R.string.fa_low_vision),
	...
	FA_MAP(R.string.fa_map),
	FA_MAP_MARKER(R.string.fa_map_marker),
	FA_MAP_O(R.string.fa_map_o),
	FA_MAP_PIN(R.string.fa_map_pin),
	FA_MAP_SIGNS(R.string.fa_map_signs),
	...
	FA_MOUSE_POINTER(R.string.fa_mouse_pointer),
	...
	FA_OBJECT_GROUP(R.string.fa_object_group),
	FA_OBJECT_UNGROUP(R.string.fa_object_ungroup),
	FA_ODNOKLASSNIKI(R.string.fa_odnoklassniki),
	FA_ODNOKLASSNIKI_SQUARE(R.string.fa_odnoklassniki_square),
	FA_OPENCART(R.string.fa_opencart),
	FA_OPENID(R.string.fa_openid),
	FA_OPERA(R.string.fa_opera),
	FA_OPTIN_MONSTER(R.string.fa_optin_monster),
	...
	FA_PAUSE_CIRCLE(R.string.fa_pause_circle),
	FA_PAUSE_CIRCLE_O(R.string.fa_pause_circle_o),
	...
	FA_PERCENT(R.string.fa_percent),
	...
	FA_PIED_PIPER_PP(R.string.fa_pied_piper_pp),
	...
	FA_PRODUCT_HUNT(R.string.fa_product_hunt),
	...
	FA_QUESTION_CIRCLE_O(R.string.fa_question_circle_o),
	...
	FA_REDDIT_ALIEN(R.string.fa_reddit_alien),
	FA_REDDIT_SQUARE(R.string.fa_reddit_square),
	FA_REFRESH(R.string.fa_refresh),
	FA_REGISTERED(R.string.fa_registered),
	...
	FA_RESISTANCE(R.string.fa_resistance),
	...
	FA_SAFARI(R.string.fa_safari),
	FA_SAVE(R.string.fa_save),
	FA_SCISSORS(R.string.fa_scissors),
	FA_SCRIBD(R.string.fa_scribd),
	...
	FA_SHOPPING_BAG(R.string.fa_shopping_bag),
	FA_SHOPPING_BASKET(R.string.fa_shopping_basket),
	FA_SHOPPING_CART(R.string.fa_shopping_cart),
	FA_SIGN_IN(R.string.fa_sign_in),
	FA_SIGN_LANGUAGE(R.string.fa_sign_language),
	FA_SIGN_OUT(R.string.fa_sign_out),
	FA_SIGNAL(R.string.fa_signal),
	FA_SIGNING(R.string.fa_signing),
	...
	FA_SNAPCHAT(R.string.fa_snapchat),
	FA_SNAPCHAT_GHOST(R.string.fa_snapchat_ghost),
	FA_SNAPCHAT_SQUARE(R.string.fa_snapchat_square),
	...
	FA_STICKY_NOTE(R.string.fa_sticky_note),
	FA_STICKY_NOTE_O(R.string.fa_sticky_note_o),
	FA_STOP(R.string.fa_stop),
	FA_STOP_CIRCLE(R.string.fa_stop_circle),
	FA_STOP_CIRCLE_O(R.string.fa_stop_circle_o),
	...
	FA_TELEVISION(R.string.fa_television),
	...
	FA_THEMEISLE(R.string.fa_themeisle),
	...
	FA_TRADEMARK(R.string.fa_trademark),
	...
	FA_TRIPADVISOR(R.string.fa_tripadvisor),
	...
	FA_UNIVERSAL_ACCESS(R.string.fa_universal_access),
	...
	FA_VIADEO(R.string.fa_viadeo),
	FA_VIADEO_SQUARE(R.string.fa_viadeo_square),
	FA_VIDEO_CAMERA(R.string.fa_video_camera),
	FA_VIMEO(R.string.fa_vimeo),
	FA_VIMEO_SQUARE(R.string.fa_vimeo_square),
	FA_VINE(R.string.fa_vine),
	FA_VK(R.string.fa_vk),
	FA_VOLUME_CONTROL_PHONE(R.string.fa_volume_control_phone),
	...
	FA_WHEELCHAIR_ALT(R.string.fa_wheelchair_alt),
	FA_WIFI(R.string.fa_wifi),
	FA_WIKIPEDIA_W(R.string.fa_wikipedia_w),
	FA_WINDOWS(R.string.fa_windows),
	FA_WON(R.string.fa_won),
	FA_WORDPRESS(R.string.fa_wordpress),
	FA_WPBEGINNER(R.string.fa_wpbeginner),
	FA_WPFORMS(R.string.fa_wpforms),
	FA_WRENCH(R.string.fa_wrench),
	FA_XING(R.string.fa_xing),
	FA_XING_SQUARE(R.string.fa_xing_square),
	FA_Y_COMBINATOR(R.string.fa_y_combinator),
	FA_Y_COMBINATOR_SQUARE(R.string.fa_y_combinator_square),
	FA_YAHOO(R.string.fa_yahoo),
	FA_YC(R.string.fa_yc),
	FA_YC_SQUARE(R.string.fa_yc_square),
	FA_YELP(R.string.fa_yelp),
	FA_YEN(R.string.fa_yen),
	FA_YOAST(R.string.fa_yoast),
